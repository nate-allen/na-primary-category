...
primaryCategory.admin = ( function( $ ) {
    ...
    return {
        ...
        setup_buttons: function() {
            ...
            if ( 1 === $elements.category_checklist.find( 'input[type=checkbox]:checked' ).length ) {
                self.remove_primary_label( category );
            }
        ...
        setup_primaryCategory: function() {
            ...
            if ( $elements.hidden_field.val() ) {
                let categoryID = $elements.hidden_field.val();

                self.add_primary_label( 'category-' + categoryID );
            }
        },
        ...
        add_primary_label: function( category ) {
            ...
            if ( category ) {
                let categoryID = category.match( /\d+/g );
        ...
        remove_primary_label: function( category ) {
            ...
            if ( $category.hasClass( 'na-is-primary-category' ) ) {
                ...
                self.maybe_set_new_primaryCategory();
            }
        },
         ...
         */
        maybe_set_new_primaryCategory: function() {
